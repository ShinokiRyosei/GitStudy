...
class CommitNumber_Commit: Object {
    ...
    dynamic internal var commit: Commit!
    dynamic internal var commitNumber: CommitNumber!
    ...
    static internal func create(withCommit commit: Commit, withCommitNumber commitNumber: CommitNumber) -> CommitNumber_Commit {
    ...
    static internal func fetch(with model: CommitNumber) -> [CommitNumber_Commit]? {
